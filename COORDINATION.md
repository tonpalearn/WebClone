...
|---|---|---|---|
| 2026-06-25 | hermes | หา 5 lead นนทบุรีภาพลักษณ์สูง (SISB/ICSN/VLA MOON/Lelana/A PLUS) + สร้าง subproject before/after, lead report, outreach draft, build+deploy prebuilt ไป tpldesign | done |
| 2026-06-25 | claude | **ปรับหน้าเทียบทุกเจ้า (6) ให้ใช้ภาพจริง (Lighthouse screenshot) + ตัวเลขวัดจริง แทน strawman** · ย่อรูป ZENVANA 8→2.3MB · วัด Lighthouse เดิม/ใหม่ทุกเจ้า: CERA 47.7s→3.4s (เร็ว 14เท่า), ZENVANA 11เท่า, บ้านปัญญาเบา 16เท่า · racha/PhedPhed speed เสมอ→ขาย feature (ไม่เคลมมั่ว) | done |
| 2026-06-24 | claude | ร่าง outreach 6 เจ้า (output/outreach-drafts-ratchaphruek.md) + ทำ project-dashboard.html (kanban ติดตาม 7 ธุรกิจ, ก๊อป message, สถานะ localStorage) — internal ไม่ deploy | done |
| 2026-06-24 | claude | fix หน้า comparison iframe ไม่ขึ้นบน production (trailingSlash:true + cleanUrls:false ใน vercel.json) + redeploy | done |
